...
[Link zur Datei](./001-simple-ec2-no-sg.cloudformation.yaml) Dieses Beispiel
setzt eine einfache EC2-Instanz ohne SG auf.

## Zweites Beispiel

[Link zur Datei](./002-simple-ec2-sg.cloudformation.yaml) Hier wird eine SG
hinzugefügt. Man kann den Stack des ersten Beispiels damit updaten.

## Drittes Beispiel

[Link zur Datei](./003-ec2-userdata-params-outputs.cloudformation.yaml) Neu in
diesem Beispiel:
...
[Link zur Datei](./011-simpleec2asg-rollingupdate.cloudformation.yaml) Hier
kommen hinzu:
...
aws cloudformation create-change-set \
    ...
    --parameters \
        ParameterKey=SSHKeyPair,ParameterValue=instructor-keypair \
...
[Link zur Datei](./012-simpleec2asg-alb.cloudformation.yaml) Dieses Beispiel
enthält zusätzlich alles, um eine ASG aufzusetzen, sowie Parametervalidierung.
...
aws cloudformation deploy \
    ...
    --template-file 001-simple-ec2-no-sg.cloudformation.yaml \
    --stack-name gfu-001-simple-ec2-no-sg
aws cloudformation describe-change-set \
    --change-set-name <change-set-arn>
aws cloudformation execute-change-set \
    --change-set-name <change-set-arn>
```
